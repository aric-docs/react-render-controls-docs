...
};`},"@jswork/react-render-controls":{type:"NPM",value:"1.2.1"},react:{type:"NPM",value:"18.3.1"}},entry:"index.tsx"},context:{"@jswork/react-render-controls":E,react:l||(l=e.t(t,2))},renderOpts:{compile:function(){var f=p()(x()().mark(function u(){var d,o=arguments;return x()().wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return n.next=2,e.e(417).then(e.bind(e,10417));case 2:return n.abrupt("return",(d=n.sent).default.apply(d,o));case 3:case"end":return n.stop()}},u)}));function a(){return f.apply(this,arguments)}return a}()}}}},12616:function(C,s,e){"use strict";e.r(s),e.d(s,{texts:function(){return l}});const l=[{value:"Complete type definitions and API documentation for all components.",paraId:0,tocIndex:0},{value:`import {
  RenderList,
  RenderIf,
  RenderMatch,
  RenderSwitch
...
`,paraId:9,tocIndex:8},{value:"Explore ",paraId:10,tocIndex:9},{value:"Component Documentation",paraId:11,tocIndex:9},{value:" for detailed usage",paraId:10,tocIndex:9},{value:"Check out ",paraId:10,tocIndex:9},{value:"API Reference",paraId:12,tocIndex:9},{value:" for complete type definitions",paraId:10,tocIndex:9}]},25921:function(C,s,e){"use strict";e.r(s),e.d(s,{texts:function(){return l}});const l=[{value:`npm install @jswork/react-render-controls
...
`,paraId:1,tocIndex:1}]},1221:function(C,s,e){"use strict";e.r(s),e.d(s,{texts:function(){return l}});const l=[{value:"Interactive demos for React Render Controls components. Click on any component below to explore live, editable examples.",paraId:0,tocIndex:0},{value:"RenderList Demos",paraId:1,tocIndex:1},{value:" - List rendering with function and component patterns",paraId:2,tocIndex:1},{value:"RenderIf Demos",paraId:3,tocIndex:1},{value:" - Conditional rendering with if/else patterns",paraId:2,tocIndex:1},{value:"RenderMatch Demos",paraId:4,tocIndex:1},{value:" - Pattern matching for status-based rendering",paraId:2,tocIndex:1},{value:"RenderSwitch Demos",paraId:5,tocIndex:1},{value:" - Switch-style conditional rendering",paraId:2,tocIndex:1},{value:"Live Editing",paraId:6,tocIndex:2},{value:" - All demos are editable in real-time",paraId:6,tocIndex:2},{value:"Interactive",paraId:6,tocIndex:2},{value:" - See changes immediately as you code",paraId:6,tocIndex:2},{value:"Type-Safe",paraId:6,tocIndex:2},{value:" - Full TypeScript support",paraId:6,tocIndex:2},{value:"Production Ready",paraId:6,tocIndex:2},{value:" - All examples follow best practices",paraId:6,tocIndex:2},{value:"Select a component above to view interactive demos. Each demo includes:",paraId:7,tocIndex:3},{value:"Complete, runnable code",paraId:8,tocIndex:3},{value:"Real-time preview",paraId:8,tocIndex:3},{value:"Editable source code",paraId:8,tocIndex:3},{value:"Usage examples and patterns",paraId:8,tocIndex:3}]},23772:function(C,s,e){"use strict";e.r(s),e.d(s,{texts:function(){return l}});const l=[{value:"Interactive demos for the RenderIf component.",paraId:0,tocIndex:0}]},15719:function(C,s,e){"use strict";e.r(s),e.d(s,{texts:function(){return l}});const l=[{value:"Interactive demos for the RenderList component.",paraId:0,tocIndex:0}]},44269:function(C,s,e){"use strict";e.r(s),e.d(s,{texts:function(){return l}});const l=[{value:"Interactive demos for the RenderMatch component.",paraId:0,tocIndex:0}]},47626:function(C,s,e){"use strict";e.r(s),e.d(s,{texts:function(){return l}});const l=[{value:"Interactive demos for the RenderSwitch component.",paraId:0,tocIndex:0}]},14224:function(C){var s=C.exports={},e,l;function S(){throw new Error("setTimeout has not been defined")}function x(){throw new Error("clearTimeout has not been defined")}(function(){try{typeof setTimeout=="function"?e=setTimeout:e=S}catch(d){e=S}try{typeof clearTimeout=="function"?l=clearTimeout:l=x}catch(d){l=x}})();function B(d){if(e===setTimeout)return setTimeout(d,0);if((e===S||!e)&&setTimeout)return e=setTimeout,setTimeout(d,0);try{return e(d,0)}catch(o){try{return e.call(null,d,0)}catch(c){return e.call(this,d,0)}}}function M(d){if(l===clearTimeout)return clearTimeout(d);if((l===x||!l)&&clearTimeout)return l=clearTimeout,clearTimeout(d);try{return l(d)}catch(o){try{return l.call(null,d)}catch(c){return l.call(this,d)}}}var L=[],p=!1,t,E=-1;function h(){!p||!t||(p=!1,t.length?L=t.concat(L):E=-1,L.length&&f())}function f(){if(!p){var d=B(h);p=!0;for(var o=L.length;o;){for(t=L,L=[];++E<o;)t&&t[E].run();E=-1,o=L.length}t=null,p=!1,M(d)}}s.nextTick=function(d){var o=new Array(arguments.length-1);if(arguments.length>1)for(var c=1;c<arguments.length;c++)o[c-1]=arguments[c];L.push(new a(d,o)),L.length===1&&!p&&B(f)};function a(d,o){this.fun=d,this.array=o}a.prototype.run=function(){this.fun.apply(null,this.array)},s.title="browser",s.browser=!0,s.env={},s.argv=[],s.version="",s.versions={};function u(){}s.on=u,s.addListener=u,s.once=u,s.off=u,s.removeListener=u,s.removeAllListeners=u,s.emit=u,s.prependListener=u,s.prependOnceListener=u,s.listeners=function(d){return[]},s.binding=function(d){throw new Error("process.binding is not supported")},s.cwd=function(){return"/"},s.chdir=function(d){throw new Error("process.chdir is not supported")},s.umask=function(){return 0}}}]);
